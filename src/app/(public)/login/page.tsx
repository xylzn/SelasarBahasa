...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center py-12 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-brand-blue-light/50 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-xl border border-white/40 reveal">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-1.5">{t('login.password')}</label>
