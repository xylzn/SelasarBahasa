...
export default function DashboardOverview({
  ...
  if (enrollment === null) {    return (
      <div className="p-6 lg:p-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 flex flex-col items-center text-center gap-4">
          ...
          <Link
            href="/#packages"
            className="mt-2 inline-flex items-center gap-2 px-6 py-3 bg-brand-blue text-white rounded-xl font-bold hover:bg-brand-blue/90 transition-colors"
          >
  ...
  if (enrollment.status === 'PENDING_PAYMENT') {
    return (
      <div className="p-6 lg:p-8">
        ...
        <div className="bg-brand-blue-light border border-brand-blue/20 rounded-2xl p-6 flex flex-col gap-4">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-xl bg-brand-blue/10 flex-shrink-0">
              <AlertCircle size={24} className="text-brand-blue" />
            </div>
            <div>
  ...
  if (enrollment.status === 'COMPLETED') {
    return (
      <div className="p-6 lg:p-8">
        ...
        <div className="bg-gradient-to-r from-green-50 to-brand-blue-light border border-green-200 rounded-2xl p-6 mb-6">
          <div className="flex items-start gap-4">
          ...
          <div className="mt-5">
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-blue text-white rounded-xl text-sm font-bold hover:bg-brand-blue/90 transition"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div className="p-3 rounded-xl bg-brand-blue/10 inline-flex mb-4">
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      {/* Active class badge */}
      <div className="mb-6 flex items-center gap-4 bg-brand-blue-light border border-brand-blue/20 rounded-2xl p-5">
        <div className="p-3 rounded-xl bg-brand-blue/10 flex-shrink-0">
        ...
        <div>
          ...
          <p className="font-bold text-brand-blue-dark">{kelasLabel}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="p-3 rounded-xl bg-brand-orange/10 inline-flex mb-4">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="p-3 rounded-xl bg-purple-100 inline-flex mb-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        {recentAttempts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <Link
              href="/dashboard/quiz"
              className="inline-flex items-center gap-2 px-6 py-3 bg-brand-blue text-white rounded-xl font-bold hover:bg-brand-blue/90 transition-colors"
            >
